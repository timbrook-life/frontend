  ...
  return (
    <div className="site">
      ...
      <section className="social">
        <a href="https://twitter.com/7imbrook">
          <i
            className="fab fa-twitter"
            data-full-name="Twitter"
            aria-hidden="true"
          ></i>
        </a>
        <a href="https://www.instagram.com/7imbrook">
          <i
            className="fab fa-instagram"
            data-full-name="Instagram"
            aria-hidden="true"
          ></i>
        </a>
        <a href="https://github.com/7imbrook">
          <i
            className="fab fa-github"
            data-full-name="GitHub"
            aria-hidden="true"
          ></i>
        </a>
        <a href="https://linkedin.com/in/michaeltimbrook">
          <i
            className="fab fa-linkedin"
            data-full-name="Linkedin"
            aria-hidden="true"
          ></i>
        </a>
        <a href="mailto:contact@timbrook.tech">
          <i
